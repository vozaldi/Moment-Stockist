    ...
    <div className={clsx("form-group", className)} {...containerProps}>
      ...
      <div className={clsx("input-text-group", error && "is-invalid")}>
        {!!InputComponent ? InputComponent : (
          <select
            className={clsx("form-control py-2 px-4 border-2 border-fucosan-pink-dark/50 rounded-lg focus:border-fucosan-pink-dark outline-none", error && "is-invalid", inputClassName)}
            style={{
